...
<head>
  ...
  <title>Travel Brewery | Customized Holiday Packages, Affordable Group Tours to Europe and South East Asia for Solo, Group and Honeymoon Travellers well within your budget</title>
...
<body>
  <header>
    ...
    <div class="header-content">
      <div class="header-content-inner">
        ...
        <hr>
        <p><h3>Solo and Group Backpacking tours across Eastern and Central Europe</h3></p>
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          ...
          <p class="text-faded">Planning and implementing an interesting and fulfilling trip is much like brewing a
            ...
            the end result can often be quite underwhelming, leaving a bad after taste.
            <br/><br/>
            ...
            European vacations that give you unlimited freedom.
  ...
  <section id="services">
    <div class="container">
          ...
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box">
              ...
              <p class="text-muted">Ask us anything - before, during and after the trip.<br/>
                Our in house expert will travel along you on backpacking trips.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="no-padding" id="Citieslist">
              ...
              <div class="portfolio-box-caption">
                <div class="portfolio-box-caption-content">
                  ...
                  <div class="project-name">
                    A city where every monument tells a story, Berlin takes you back in time.
                  </div>
                </div>
              </div>
            </a>
          ...
          <div class="col-lg-4 col-sm-6 portfolio-box">
            ...
            <div class="portfolio-box-caption">
              <div class="portfolio-box-caption-content">
                ...
                <div class="project-name">
                  A Backpacker's delight with a beautiful river front, legendary Ruin Bars and 15th century Turkish Baths
                </div>
              </div>
            </div>
          </a>
        ...
        <div class="col-lg-4 col-sm-6 portfolio-box">
          ...
          <div class="portfolio-box-caption">
            <div class="portfolio-box-caption-content">
              ...
              <div class="project-name">
                The heart of Europe, soak in the beauty  of Prague with a Chilled Beer :D
              </div>
            </div>
          </div>
        </a>
      ...
      <div class="col-lg-4 col-sm-6 portfolio-box">
        ...
        <div class="portfolio-box-caption">
          <div class="portfolio-box-caption-content">
            ...
            <div class="project-name">
              Dine like a royal in the Old Town Center
            </div>
          </div>
        </div>
      </a>
    ...
    <div class="col-lg-4 col-sm-6 portfolio-box">
      ...
      <div class="portfolio-box-caption">
        <div class="portfolio-box-caption-content">
          ...
          <div class="project-name">
            The European epicenter of arts, music and culture
          </div>
        </div>
      </div>
    </a>
